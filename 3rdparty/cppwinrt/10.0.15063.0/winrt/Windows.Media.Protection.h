...
template<>
struct std::hash<winrt::Windows::Media::Protection::IComponentRenewalStatics>
{
    size_t operator()(const winrt::Windows::Media::Protection::IComponentRenewalStatics & value) const noexcept
    {
        return winrt::impl::hash_unknown(value);
    }
};
