...
template<>
struct std::hash<winrt::Windows::Phone::System::Power::IPowerManagerStatics>
{
    size_t operator()(const winrt::Windows::Phone::System::Power::IPowerManagerStatics & value) const noexcept
    {
...
template<>
struct std::hash<winrt::Windows::Phone::System::Power::IPowerManagerStatics2>
{
    size_t operator()(const winrt::Windows::Phone::System::Power::IPowerManagerStatics2 & value) const noexcept
    {
        return winrt::impl::hash_unknown(value);
    }
};
