...
#ifndef WINRT_GENERIC_7d899fb2_4666_5a3e_b36c_9886bcbc4663
#define WINRT_GENERIC_7d899fb2_4666_5a3e_b36c_9886bcbc4663
...
#ifndef WINRT_GENERIC_b2d8ddb4_d2b8_5930_942d_26118756bd46
#define WINRT_GENERIC_b2d8ddb4_d2b8_5930_942d_26118756bd46
template <> struct __declspec(uuid("b2d8ddb4-d2b8-5930-942d-26118756bd46")) __declspec(novtable) IVector<Windows::UI::Xaml::Media::TimelineMarker> : impl_IVector<Windows::UI::Xaml::Media::TimelineMarker> {};
#endif

#ifndef WINRT_GENERIC_946c5af5_4c09_5784_9cf2_506947378e8e
#define WINRT_GENERIC_946c5af5_4c09_5784_9cf2_506947378e8e
template <> struct __declspec(uuid("946c5af5-4c09-5784-9cf2-506947378e8e")) __declspec(novtable) IIterable<Windows::UI::Xaml::Media::TimelineMarker> : impl_IIterable<Windows::UI::Xaml::Media::TimelineMarker> {};
#endif

#ifndef WINRT_GENERIC_62d7bbc1_71f5_5611_a984_e571c2de7baa
#define WINRT_GENERIC_62d7bbc1_71f5_5611_a984_e571c2de7baa
template <> struct __declspec(uuid("62d7bbc1-71f5-5611-a984-e571c2de7baa")) __declspec(novtable) IVector<Windows::UI::Xaml::Media::Transform> : impl_IVector<Windows::UI::Xaml::Media::Transform> {};
#endif

#ifndef WINRT_GENERIC_fb8cacbc_d3ec_51b8_9778_99ede8463611
#define WINRT_GENERIC_fb8cacbc_d3ec_51b8_9778_99ede8463611
template <> struct __declspec(uuid("fb8cacbc-d3ec-51b8-9778-99ede8463611")) __declspec(novtable) IIterable<Windows::UI::Xaml::Media::Transform> : impl_IIterable<Windows::UI::Xaml::Media::Transform> {};
#endif

#ifndef WINRT_GENERIC_84c6ac3a_8207_5599_9583_606ac2139ddd
#define WINRT_GENERIC_84c6ac3a_8207_5599_9583_606ac2139ddd
template <> struct __declspec(uuid("84c6ac3a-8207-5599-9583-606ac2139ddd")) __declspec(novtable) IVector<Windows::UI::Xaml::Media::Geometry> : impl_IVector<Windows::UI::Xaml::Media::Geometry> {};
#endif

#ifndef WINRT_GENERIC_35340039_0dfc_52b4_8748_0d9a755db8a8
#define WINRT_GENERIC_35340039_0dfc_52b4_8748_0d9a755db8a8
template <> struct __declspec(uuid("35340039-0dfc-52b4-8748-0d9a755db8a8")) __declspec(novtable) IIterable<Windows::UI::Xaml::Media::Geometry> : impl_IIterable<Windows::UI::Xaml::Media::Geometry> {};
#endif

#ifndef WINRT_GENERIC_33422da4_24f3_5b52_9e8d_11dd71f08bb1
#define WINRT_GENERIC_33422da4_24f3_5b52_9e8d_11dd71f08bb1
template <> struct __declspec(uuid("33422da4-24f3-5b52-9e8d-11dd71f08bb1")) __declspec(novtable) IVector<Windows::UI::Xaml::Media::GradientStop> : impl_IVector<Windows::UI::Xaml::Media::GradientStop> {};
#endif

#ifndef WINRT_GENERIC_9105bb93_ac26_5bae_8c1e_df8ecf00dee6
#define WINRT_GENERIC_9105bb93_ac26_5bae_8c1e_df8ecf00dee6
...
#ifndef WINRT_GENERIC_cd1dc421_d6e5_5b3f_a8c7_9938f28b2995
#define WINRT_GENERIC_cd1dc421_d6e5_5b3f_a8c7_9938f28b2995
template <> struct __declspec(uuid("cd1dc421-d6e5-5b3f-a8c7-9938f28b2995")) __declspec(novtable) IIterable<Windows::UI::Xaml::Media::PathFigure> : impl_IIterable<Windows::UI::Xaml::Media::PathFigure> {};
#endif

#ifndef WINRT_GENERIC_11fdd506_b21d_564d_b6a8_ff991057b8f3
#define WINRT_GENERIC_11fdd506_b21d_564d_b6a8_ff991057b8f3
template <> struct __declspec(uuid("11fdd506-b21d-564d-b6a8-ff991057b8f3")) __declspec(novtable) IVector<Windows::UI::Xaml::Media::PathSegment> : impl_IVector<Windows::UI::Xaml::Media::PathSegment> {};
#endif

#ifndef WINRT_GENERIC_37e2cb21_b9c9_5006_bed7_4c328981b551
#define WINRT_GENERIC_37e2cb21_b9c9_5006_bed7_4c328981b551
...
#define WINRT_GENERIC_5bcb0970_5472_56e8_b184_d01fb81e408a
template <> struct __declspec(uuid("5bcb0970-5472-56e8-b184-d01fb81e408a")) __declspec(novtable) IIterator<Windows::UI::Xaml::Controls::Primitives::Popup> : impl_IIterator<Windows::UI::Xaml::Controls::Primitives::Popup> {};
#endif

#ifndef WINRT_GENERIC_0af05ce9_3b0f_5a6d_a053_d01a1a554f8c
#define WINRT_GENERIC_0af05ce9_3b0f_5a6d_a053_d01a1a554f8c
template <> struct __declspec(uuid("0af05ce9-3b0f-5a6d-a053-d01a1a554f8c")) __declspec(novtable) IIterable<Windows::UI::Xaml::Controls::Primitives::Popup> : impl_IIterable<Windows::UI::Xaml::Controls::Primitives::Popup> {};
#endif
...
#define WINRT_GENERIC_63e1e513_fca3_51c0_8c2b_09db5f8f4c40
template <> struct __declspec(uuid("63e1e513-fca3-51c0-8c2b-09db5f8f4c40")) __declspec(novtable) IIterator<Windows::UI::Xaml::Media::TimelineMarker> : impl_IIterator<Windows::UI::Xaml::Media::TimelineMarker> {};
#endif

#ifndef WINRT_GENERIC_fef8133f_98e9_5ca3_a667_0d234c5d1d96
#define WINRT_GENERIC_fef8133f_98e9_5ca3_a667_0d234c5d1d96
template <> struct __declspec(uuid("fef8133f-98e9-5ca3-a667-0d234c5d1d96")) __declspec(novtable) IVectorView<Windows::UI::Xaml::Media::TimelineMarker> : impl_IVectorView<Windows::UI::Xaml::Media::TimelineMarker> {};
#endif

#ifndef WINRT_GENERIC_2cdbd536_4598_5f0f_a236_11ec053c8e4b
#define WINRT_GENERIC_2cdbd536_4598_5f0f_a236_11ec053c8e4b
template <> struct __declspec(uuid("2cdbd536-4598-5f0f-a236-11ec053c8e4b")) __declspec(novtable) IIterator<Windows::UI::Xaml::Media::Transform> : impl_IIterator<Windows::UI::Xaml::Media::Transform> {};
#endif

#ifndef WINRT_GENERIC_b3a869c7_9c78_525b_943e_16a2c8979b03
#define WINRT_GENERIC_b3a869c7_9c78_525b_943e_16a2c8979b03
template <> struct __declspec(uuid("b3a869c7-9c78-525b-943e-16a2c8979b03")) __declspec(novtable) IVectorView<Windows::UI::Xaml::Media::Transform> : impl_IVectorView<Windows::UI::Xaml::Media::Transform> {};
#endif

#ifndef WINRT_GENERIC_8726dcbf_961d_527a_a7cb_2db47e1c9092
#define WINRT_GENERIC_8726dcbf_961d_527a_a7cb_2db47e1c9092
template <> struct __declspec(uuid("8726dcbf-961d-527a-a7cb-2db47e1c9092")) __declspec(novtable) IIterator<Windows::UI::Xaml::Media::Geometry> : impl_IIterator<Windows::UI::Xaml::Media::Geometry> {};
#endif

#ifndef WINRT_GENERIC_1905e02c_de78_5136_b761_7b7a33402583
#define WINRT_GENERIC_1905e02c_de78_5136_b761_7b7a33402583
template <> struct __declspec(uuid("1905e02c-de78-5136-b761-7b7a33402583")) __declspec(novtable) IVectorView<Windows::UI::Xaml::Media::Geometry> : impl_IVectorView<Windows::UI::Xaml::Media::Geometry> {};
#endif

#ifndef WINRT_GENERIC_01dca32b_0938_5e4a_94ad_bb4906f651ed
#define WINRT_GENERIC_01dca32b_0938_5e4a_94ad_bb4906f651ed
template <> struct __declspec(uuid("01dca32b-0938-5e4a-94ad-bb4906f651ed")) __declspec(novtable) IIterator<Windows::UI::Xaml::Media::GradientStop> : impl_IIterator<Windows::UI::Xaml::Media::GradientStop> {};
#endif

#ifndef WINRT_GENERIC_4c4a7b50_4bc3_52cb_8c81_2ea77702b566
#define WINRT_GENERIC_4c4a7b50_4bc3_52cb_8c81_2ea77702b566
template <> struct __declspec(uuid("4c4a7b50-4bc3-52cb-8c81-2ea77702b566")) __declspec(novtable) IVectorView<Windows::UI::Xaml::Media::GradientStop> : impl_IVectorView<Windows::UI::Xaml::Media::GradientStop> {};
#endif

#ifndef WINRT_GENERIC_71bd579b_088e_5e59_8876_80613dcff83e
#define WINRT_GENERIC_71bd579b_088e_5e59_8876_80613dcff83e
template <> struct __declspec(uuid("71bd579b-088e-5e59-8876-80613dcff83e")) __declspec(novtable) IIterator<Windows::UI::Xaml::Media::PathFigure> : impl_IIterator<Windows::UI::Xaml::Media::PathFigure> {};
#endif

#ifndef WINRT_GENERIC_bfe78700_1265_548c_a06b_259cc2bd032b
#define WINRT_GENERIC_bfe78700_1265_548c_a06b_259cc2bd032b
template <> struct __declspec(uuid("bfe78700-1265-548c-a06b-259cc2bd032b")) __declspec(novtable) IVectorView<Windows::UI::Xaml::Media::PathFigure> : impl_IVectorView<Windows::UI::Xaml::Media::PathFigure> {};
#endif

#ifndef WINRT_GENERIC_3cfedcfb_7a75_5bc7_a7e2_95ee9bc6dd32
#define WINRT_GENERIC_3cfedcfb_7a75_5bc7_a7e2_95ee9bc6dd32
template <> struct __declspec(uuid("3cfedcfb-7a75-5bc7-a7e2-95ee9bc6dd32")) __declspec(novtable) IIterator<Windows::UI::Xaml::Media::PathSegment> : impl_IIterator<Windows::UI::Xaml::Media::PathSegment> {};
#endif

#ifndef WINRT_GENERIC_54735271_a3db_5e42_85be_4ff85432364b
#define WINRT_GENERIC_54735271_a3db_5e42_85be_4ff85432364b
template <> struct __declspec(uuid("54735271-a3db-5e42-85be-4ff85432364b")) __declspec(novtable) IVectorView<Windows::UI::Xaml::Media::PathSegment> : impl_IVectorView<Windows::UI::Xaml::Media::PathSegment> {};
#endif
