...
struct __declspec(uuid("7116aa34-5d6d-4b4a-96a3-efa47d2a7e25")) __declspec(novtable) ISmartCardCryptogramGenerator2 : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall abi_ValidateRequestApduAsync(winrt::Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, Windows::Storage::Streams::IBuffer * apduToValidate, Windows::Foundation::Collections::IIterable<Windows::Devices::SmartCards::SmartCardCryptogramPlacementStep> * cryptogramPlacementSteps, Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus> ** result) = 0;
    virtual HRESULT __stdcall abi_GetAllCryptogramStorageKeyCharacteristicsAsync(Windows::Foundation::IAsyncOperation<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult> ** result) = 0;
    virtual HRESULT __stdcall abi_GetAllCryptogramMaterialPackageCharacteristicsAsync(Windows::Foundation::IAsyncOperation<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult> ** result) = 0;
    virtual HRESULT __stdcall abi_GetAllCryptogramMaterialPackageCharacteristicsWithStorageKeyAsync(hstring storageKeyName, Windows::Foundation::IAsyncOperation<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult> ** result) = 0;
    virtual HRESULT __stdcall abi_GetAllCryptogramMaterialCharacteristicsAsync(winrt::Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, hstring materialPackageName, Windows::Foundation::IAsyncOperation<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult> ** result) = 0;
};
...
struct __declspec(uuid("2798e029-d687-4c92-86c6-399e9a0ecb09")) __declspec(novtable) ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult : Windows::Foundation::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Characteristics(Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramMaterialCharacteristics> ** value) = 0;
};

struct __declspec(uuid("4e6a8a5c-9773-46c4-a32f-b1e543159e04")) __declspec(novtable) ISmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall get_OperationStatus(winrt::Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus * value) = 0;
    virtual HRESULT __stdcall get_Characteristics(Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageCharacteristics> ** value) = 0;
};

struct __declspec(uuid("8c7ce857-a7e7-489d-b9d6-368061515012")) __declspec(novtable) ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall get_OperationStatus(winrt::Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus * value) = 0;
    virtual HRESULT __stdcall get_Characteristics(Windows::Foundation::Collections::IVectorView<Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCharacteristics> ** value) = 0;
};

struct __declspec(uuid("fc9ac5cc-c1d7-4153-923b-a2d43c6c8d49")) __declspec(novtable) ISmartCardCryptogramMaterialCharacteristics : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall get_MaterialName(hstring * value) = 0;
    virtual HRESULT __stdcall get_AllowedAlgorithms(Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm> ** value) = 0;
    virtual HRESULT __stdcall get_AllowedProofOfPossessionAlgorithms(Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageConfirmationResponseFormat> ** value) = 0;
    virtual HRESULT __stdcall get_AllowedValidations(Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm> ** value) = 0;
    virtual HRESULT __stdcall get_MaterialType(winrt::Windows::Devices::SmartCards::SmartCardCryptogramMaterialType * value) = 0;
    virtual HRESULT __stdcall get_ProtectionMethod(winrt::Windows::Devices::SmartCards::SmartCardCryptogramMaterialProtectionMethod * value) = 0;
...
struct __declspec(uuid("ffb58e1f-0692-4c47-93cf-34d91f9dcd00")) __declspec(novtable) ISmartCardCryptogramMaterialPackageCharacteristics : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall get_PackageName(hstring * value) = 0;
    virtual HRESULT __stdcall get_StorageKeyName(hstring * value) = 0;
    virtual HRESULT __stdcall get_DateImported(Windows::Foundation::DateTime * value) = 0;
    virtual HRESULT __stdcall get_PackageFormat(winrt::Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageFormat * value) = 0;
};
...
struct __declspec(uuid("8552546e-4457-4825-b464-635471a39f5c")) __declspec(novtable) ISmartCardCryptogramStorageKeyCharacteristics : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall get_StorageKeyName(hstring * value) = 0;
    virtual HRESULT __stdcall get_DateCreated(Windows::Foundation::DateTime * value) = 0;
    virtual HRESULT __stdcall get_Algorithm(winrt::Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyAlgorithm * value) = 0;
...
struct __declspec(uuid("b3e2c27d-18c6-4ba8-8376-ef03d4912666")) __declspec(novtable) ISmartCardTriggerDetails3 : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall get_SmartCard(Windows::Devices::SmartCards::ISmartCard ** value) = 0;
};
...
template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult> { using default_interface = Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult; };
template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult> { using default_interface = Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult; };
template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult> { using default_interface = Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult; };
template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramMaterialCharacteristics> { using default_interface = Windows::Devices::SmartCards::ISmartCardCryptogramMaterialCharacteristics; };
template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageCharacteristics> { using default_interface = Windows::Devices::SmartCards::ISmartCardCryptogramMaterialPackageCharacteristics; };
...
template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCharacteristics> { using default_interface = Windows::Devices::SmartCards::ISmartCardCryptogramStorageKeyCharacteristics; };
...
template <typename D>
struct WINRT_EBO impl_ISmartCardCryptogramGenerator2
{
    ...
    Windows::Foundation::IAsyncOperation<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult> GetAllCryptogramMaterialPackageCharacteristicsAsync(hstring_view storageKeyName) const;
    Windows::Foundation::IAsyncOperation<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult> GetAllCryptogramMaterialCharacteristicsAsync(Windows::Devices::SmartCards::SmartCardUnlockPromptingBehavior promptingBehavior, hstring_view materialPackageName) const;
};
...
template <typename D>
struct WINRT_EBO impl_ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult
{
...
template <typename D>
struct WINRT_EBO impl_ISmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult
{
    Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus OperationStatus() const;
...
template <typename D>
struct WINRT_EBO impl_ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult
{
    Windows::Devices::SmartCards::SmartCardCryptogramGeneratorOperationStatus OperationStatus() const;
...
template <typename D>
struct WINRT_EBO impl_ISmartCardCryptogramMaterialCharacteristics
{
    hstring MaterialName() const;
    Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm> AllowedAlgorithms() const;
    Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageConfirmationResponseFormat> AllowedProofOfPossessionAlgorithms() const;
    Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::SmartCards::SmartCardCryptogramAlgorithm> AllowedValidations() const;
...
template <typename D>
struct WINRT_EBO impl_ISmartCardCryptogramMaterialPackageCharacteristics
{
...
template <typename D>
struct WINRT_EBO impl_ISmartCardCryptogramStorageKeyCharacteristics
{
    hstring StorageKeyName() const;
...
template <typename D>
struct WINRT_EBO impl_ISmartCardTriggerDetails3
{
    Windows::Devices::SmartCards::SmartCard SmartCard() const;
};
...
template <> struct traits<Windows::Devices::SmartCards::ISmartCardCryptogramGenerator2>
{
    using abi = ABI::Windows::Devices::SmartCards::ISmartCardCryptogramGenerator2;
    template <typename D> using consume = Windows::Devices::SmartCards::impl_ISmartCardCryptogramGenerator2<D>;
};
...
template <> struct traits<Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult>
{
    using abi = ABI::Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult;
    template <typename D> using consume = Windows::Devices::SmartCards::impl_ISmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult<D>;
};

template <> struct traits<Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult>
{
    using abi = ABI::Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult;
    template <typename D> using consume = Windows::Devices::SmartCards::impl_ISmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult<D>;
};

template <> struct traits<Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult>
{
    using abi = ABI::Windows::Devices::SmartCards::ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult;
    template <typename D> using consume = Windows::Devices::SmartCards::impl_ISmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult<D>;
};

template <> struct traits<Windows::Devices::SmartCards::ISmartCardCryptogramMaterialCharacteristics>
{
    using abi = ABI::Windows::Devices::SmartCards::ISmartCardCryptogramMaterialCharacteristics;
    template <typename D> using consume = Windows::Devices::SmartCards::impl_ISmartCardCryptogramMaterialCharacteristics<D>;
};

template <> struct traits<Windows::Devices::SmartCards::ISmartCardCryptogramMaterialPackageCharacteristics>
{
    using abi = ABI::Windows::Devices::SmartCards::ISmartCardCryptogramMaterialPackageCharacteristics;
    template <typename D> using consume = Windows::Devices::SmartCards::impl_ISmartCardCryptogramMaterialPackageCharacteristics<D>;
};
...
template <> struct traits<Windows::Devices::SmartCards::ISmartCardCryptogramStorageKeyCharacteristics>
{
    using abi = ABI::Windows::Devices::SmartCards::ISmartCardCryptogramStorageKeyCharacteristics;
    template <typename D> using consume = Windows::Devices::SmartCards::impl_ISmartCardCryptogramStorageKeyCharacteristics<D>;
};
...
template <> struct traits<Windows::Devices::SmartCards::ISmartCardTriggerDetails3>
{
    using abi = ABI::Windows::Devices::SmartCards::ISmartCardTriggerDetails3;
    template <typename D> using consume = Windows::Devices::SmartCards::impl_ISmartCardTriggerDetails3<D>;
};
...
template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult>
{
    using abi = ABI::Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult;
    static constexpr const wchar_t * name() noexcept { return L"Windows.Devices.SmartCards.SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult"; }
};

template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult>
{
    using abi = ABI::Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult;
    static constexpr const wchar_t * name() noexcept { return L"Windows.Devices.SmartCards.SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult"; }
};

template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult>
{
    using abi = ABI::Windows::Devices::SmartCards::SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult;
    static constexpr const wchar_t * name() noexcept { return L"Windows.Devices.SmartCards.SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult"; }
};

template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramMaterialCharacteristics>
{
    using abi = ABI::Windows::Devices::SmartCards::SmartCardCryptogramMaterialCharacteristics;
    static constexpr const wchar_t * name() noexcept { return L"Windows.Devices.SmartCards.SmartCardCryptogramMaterialCharacteristics"; }
};

template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageCharacteristics>
{
    using abi = ABI::Windows::Devices::SmartCards::SmartCardCryptogramMaterialPackageCharacteristics;
    static constexpr const wchar_t * name() noexcept { return L"Windows.Devices.SmartCards.SmartCardCryptogramMaterialPackageCharacteristics"; }
};
...
template <> struct traits<Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCharacteristics>
{
    using abi = ABI::Windows::Devices::SmartCards::SmartCardCryptogramStorageKeyCharacteristics;
    static constexpr const wchar_t * name() noexcept { return L"Windows.Devices.SmartCards.SmartCardCryptogramStorageKeyCharacteristics"; }
};
