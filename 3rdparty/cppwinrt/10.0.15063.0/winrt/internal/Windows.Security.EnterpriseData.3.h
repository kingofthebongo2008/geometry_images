...
struct FileProtectionManager
{
    ...
    static Windows::Foundation::IAsyncOperation<Windows::Security::EnterpriseData::FileProtectionInfo> UnprotectAsync(const Windows::Storage::IStorageItem & target);
    static Windows::Foundation::IAsyncOperation<Windows::Security::EnterpriseData::FileProtectionInfo> UnprotectAsync(const Windows::Storage::IStorageItem & target, const Windows::Security::EnterpriseData::FileUnprotectOptions & options);
};
    ...
    impl::require<ProtectionPolicyManager, Windows::Security::EnterpriseData::IProtectionPolicyManager2>
{
    ...
    static bool IsRoamableProtectionEnabled(hstring_view identity);
    ...
    static Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> RequestAccessToFilesForAppAsync(iterable<Windows::Storage::IStorageItem> sourceItemList, hstring_view appPackageFamilyName, const Windows::Security::EnterpriseData::ProtectionPolicyAuditInfo & auditInfo, hstring_view messageFromApp, Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior);
    static Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> RequestAccessToFilesForProcessAsync(iterable<Windows::Storage::IStorageItem> sourceItemList, uint32_t processId, const Windows::Security::EnterpriseData::ProtectionPolicyAuditInfo & auditInfo);
    ...
    static Windows::Foundation::IAsyncOperation<bool> IsFileProtectionRequiredAsync(const Windows::Storage::IStorageItem & target, hstring_view identity);
    static Windows::Foundation::IAsyncOperation<bool> IsFileProtectionRequiredForNewFileAsync(const Windows::Storage::IStorageFolder & parentFolder, hstring_view identity, hstring_view desiredName);
    static hstring PrimaryManagedIdentity();
    static hstring GetPrimaryManagedIdentityForIdentity(hstring_view identity);
};
