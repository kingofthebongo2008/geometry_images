...
template <typename T> struct impl_IFileProtectionManagerStatics3;
template <typename T> struct impl_IFileRevocationManagerStatics;
template <typename T> struct impl_IFileUnprotectOptions;
template <typename T> struct impl_IFileUnprotectOptionsFactory;
...
template <typename T> struct impl_IProtectionPolicyManagerStatics4;
