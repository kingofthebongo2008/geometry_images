...
struct __declspec(uuid("0f69a02f-9c34-43c7-a8c3-70b30a7f7504")) __declspec(novtable) IShutdownManagerStatics2 : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall abi_IsPowerStateSupported(winrt::Windows::System::PowerState powerState, bool * value) = 0;
    virtual HRESULT __stdcall abi_EnterPowerState(winrt::Windows::System::PowerState powerState) = 0;
    virtual HRESULT __stdcall abi_EnterPowerStateWithTimeSpan(winrt::Windows::System::PowerState powerState, Windows::Foundation::TimeSpan wakeUpAfter) = 0;
};
...
template <typename D>
struct WINRT_EBO impl_IShutdownManagerStatics2
{
    bool IsPowerStateSupported(Windows::System::PowerState powerState) const;
    void EnterPowerState(Windows::System::PowerState powerState) const;
    void EnterPowerState(Windows::System::PowerState powerState, const Windows::Foundation::TimeSpan & wakeUpAfter) const;
};
...
template <> struct traits<Windows::System::IShutdownManagerStatics2>
{
    using abi = ABI::Windows::System::IShutdownManagerStatics2;
    template <typename D> using consume = Windows::System::impl_IShutdownManagerStatics2<D>;
};
