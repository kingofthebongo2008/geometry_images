...
struct __declspec(uuid("74d4f496-8d37-44ec-9481-2a0b9854eb48")) __declspec(novtable) IAppBroadcastTrigger : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall put_ProviderInfo(Windows::ApplicationModel::Background::IAppBroadcastTriggerProviderInfo * value) = 0;
    virtual HRESULT __stdcall get_ProviderInfo(Windows::ApplicationModel::Background::IAppBroadcastTriggerProviderInfo ** value) = 0;
};

struct __declspec(uuid("280b9f44-22f4-4618-a02e-e7e411eb7238")) __declspec(novtable) IAppBroadcastTriggerFactory : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall abi_CreateAppBroadcastTrigger(hstring providerKey, Windows::ApplicationModel::Background::IAppBroadcastTrigger ** broadcastTrigger) = 0;
};

struct __declspec(uuid("f219352d-9de8-4420-9ce2-5eff8f17376b")) __declspec(novtable) IAppBroadcastTriggerProviderInfo : Windows::Foundation::IInspectable
{
    ...
    virtual HRESULT __stdcall put_VideoKeyFrameInterval(Windows::Foundation::TimeSpan value) = 0;
    virtual HRESULT __stdcall get_VideoKeyFrameInterval(Windows::Foundation::TimeSpan * value) = 0;
...
template <> struct traits<Windows::ApplicationModel::Background::AppBroadcastTrigger> { using default_interface = Windows::ApplicationModel::Background::IAppBroadcastTrigger; };
template <> struct traits<Windows::ApplicationModel::Background::AppBroadcastTriggerProviderInfo> { using default_interface = Windows::ApplicationModel::Background::IAppBroadcastTriggerProviderInfo; };
...
template <typename D>
struct WINRT_EBO impl_IAppBroadcastTrigger
{
    void ProviderInfo(const Windows::ApplicationModel::Background::AppBroadcastTriggerProviderInfo & value) const;
    Windows::ApplicationModel::Background::AppBroadcastTriggerProviderInfo ProviderInfo() const;
};

template <typename D>
struct WINRT_EBO impl_IAppBroadcastTriggerFactory
{
    Windows::ApplicationModel::Background::AppBroadcastTrigger CreateAppBroadcastTrigger(hstring_view providerKey) const;
};

template <typename D>
struct WINRT_EBO impl_IAppBroadcastTriggerProviderInfo
{
    void DisplayNameResource(hstring_view value) const;
    hstring DisplayNameResource() const;
    void LogoResource(hstring_view value) const;
    hstring LogoResource() const;
    void VideoKeyFrameInterval(const Windows::Foundation::TimeSpan & value) const;
...
template <> struct traits<Windows::ApplicationModel::Background::IAppBroadcastTrigger>
{
    using abi = ABI::Windows::ApplicationModel::Background::IAppBroadcastTrigger;
    template <typename D> using consume = Windows::ApplicationModel::Background::impl_IAppBroadcastTrigger<D>;
};

template <> struct traits<Windows::ApplicationModel::Background::IAppBroadcastTriggerFactory>
{
    using abi = ABI::Windows::ApplicationModel::Background::IAppBroadcastTriggerFactory;
    template <typename D> using consume = Windows::ApplicationModel::Background::impl_IAppBroadcastTriggerFactory<D>;
};

template <> struct traits<Windows::ApplicationModel::Background::IAppBroadcastTriggerProviderInfo>
{
    using abi = ABI::Windows::ApplicationModel::Background::IAppBroadcastTriggerProviderInfo;
    template <typename D> using consume = Windows::ApplicationModel::Background::impl_IAppBroadcastTriggerProviderInfo<D>;
};
...
template <> struct traits<Windows::ApplicationModel::Background::AppBroadcastTrigger>
{
    using abi = ABI::Windows::ApplicationModel::Background::AppBroadcastTrigger;
    static constexpr const wchar_t * name() noexcept { return L"Windows.ApplicationModel.Background.AppBroadcastTrigger"; }
};

template <> struct traits<Windows::ApplicationModel::Background::AppBroadcastTriggerProviderInfo>
{
    using abi = ABI::Windows::ApplicationModel::Background::AppBroadcastTriggerProviderInfo;
    static constexpr const wchar_t * name() noexcept { return L"Windows.ApplicationModel.Background.AppBroadcastTriggerProviderInfo"; }
};
