...
struct ShutdownManager
{
    ...
    static bool IsPowerStateSupported(Windows::System::PowerState powerState);
    static void EnterPowerState(Windows::System::PowerState powerState);
    static void EnterPowerState(Windows::System::PowerState powerState, const Windows::Foundation::TimeSpan & wakeUpAfter);
};
