...
template <> struct __declspec(uuid("7c5f5192-9fc0-5543-9bc4-411482e4ea93")) __declspec(novtable) TypedEventHandler<Windows::ApplicationModel::Calls::PhoneLine, Windows::Foundation::IInspectable> : impl_TypedEventHandler<Windows::ApplicationModel::Calls::PhoneLine, Windows::Foundation::IInspectable> {};
#endif
...
template <> struct __declspec(uuid("d55ce56a-23ac-5185-bf76-2808ec83c78b")) __declspec(novtable) TypedEventHandler<Windows::ApplicationModel::Calls::PhoneLineWatcher, Windows::Foundation::IInspectable> : impl_TypedEventHandler<Windows::ApplicationModel::Calls::PhoneLineWatcher, Windows::Foundation::IInspectable> {};
#endif
