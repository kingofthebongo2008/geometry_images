...
struct __declspec(uuid("6918849a-624f-46d6-b241-e9cd5fdf3e3f")) __declspec(novtable) IFileProtectionManagerStatics3 : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall abi_UnprotectAsync(Windows::Storage::IStorageItem * target, Windows::Foundation::IAsyncOperation<Windows::Security::EnterpriseData::FileProtectionInfo> ** result) = 0;
    virtual HRESULT __stdcall abi_UnprotectWithOptionsAsync(Windows::Storage::IStorageItem * target, Windows::Security::EnterpriseData::IFileUnprotectOptions * options, Windows::Foundation::IAsyncOperation<Windows::Security::EnterpriseData::FileProtectionInfo> ** result) = 0;
};
...
struct __declspec(uuid("7d1312f1-3b0d-4dd8-a1f8-1ec53822e2f3")) __declspec(novtable) IFileUnprotectOptions : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall put_Audit(bool value) = 0;
    virtual HRESULT __stdcall get_Audit(bool * value) = 0;
};

struct __declspec(uuid("51aeb39c-da8c-4c3f-9bfb-cb73a7cce0dd")) __declspec(novtable) IFileUnprotectOptionsFactory : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall abi_Create(bool audit, Windows::Security::EnterpriseData::IFileUnprotectOptions ** result) = 0;
};
...
struct __declspec(uuid("20b794db-ccbd-490f-8c83-49ccb77aea6c")) __declspec(novtable) IProtectionPolicyManagerStatics4 : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall abi_IsRoamableProtectionEnabled(hstring identity, bool * value) = 0;
    virtual HRESULT __stdcall abi_RequestAccessWithBehaviorAsync(hstring sourceIdentity, hstring targetIdentity, Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo * auditInfo, hstring messageFromApp, winrt::Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior, Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> ** result) = 0;
    virtual HRESULT __stdcall abi_RequestAccessForAppWithBehaviorAsync(hstring sourceIdentity, hstring appPackageFamilyName, Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo * auditInfo, hstring messageFromApp, winrt::Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior, Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> ** result) = 0;
    virtual HRESULT __stdcall abi_RequestAccessToFilesForAppAsync(Windows::Foundation::Collections::IIterable<Windows::Storage::IStorageItem> * sourceItemList, hstring appPackageFamilyName, Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo * auditInfo, Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> ** result) = 0;
    virtual HRESULT __stdcall abi_RequestAccessToFilesForAppWithMessageAndBehaviorAsync(Windows::Foundation::Collections::IIterable<Windows::Storage::IStorageItem> * sourceItemList, hstring appPackageFamilyName, Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo * auditInfo, hstring messageFromApp, winrt::Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior, Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> ** result) = 0;
    virtual HRESULT __stdcall abi_RequestAccessToFilesForProcessAsync(Windows::Foundation::Collections::IIterable<Windows::Storage::IStorageItem> * sourceItemList, uint32_t processId, Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo * auditInfo, Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> ** result) = 0;
    virtual HRESULT __stdcall abi_RequestAccessToFilesForProcessWithMessageAndBehaviorAsync(Windows::Foundation::Collections::IIterable<Windows::Storage::IStorageItem> * sourceItemList, uint32_t processId, Windows::Security::EnterpriseData::IProtectionPolicyAuditInfo * auditInfo, hstring messageFromApp, winrt::Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior, Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> ** result) = 0;
    virtual HRESULT __stdcall abi_IsFileProtectionRequiredAsync(Windows::Storage::IStorageItem * target, hstring identity, Windows::Foundation::IAsyncOperation<bool> ** result) = 0;
    virtual HRESULT __stdcall abi_IsFileProtectionRequiredForNewFileAsync(Windows::Storage::IStorageFolder * parentFolder, hstring identity, hstring desiredName, Windows::Foundation::IAsyncOperation<bool> ** result) = 0;
    virtual HRESULT __stdcall get_PrimaryManagedIdentity(hstring * value) = 0;
    virtual HRESULT __stdcall abi_GetPrimaryManagedIdentityForIdentity(hstring identity, hstring * value) = 0;
};
...
template <> struct traits<Windows::Security::EnterpriseData::FileUnprotectOptions> { using default_interface = Windows::Security::EnterpriseData::IFileUnprotectOptions; };
...
template <typename D>
struct WINRT_EBO impl_IFileProtectionManagerStatics3
{
    Windows::Foundation::IAsyncOperation<Windows::Security::EnterpriseData::FileProtectionInfo> UnprotectAsync(const Windows::Storage::IStorageItem & target) const;
    Windows::Foundation::IAsyncOperation<Windows::Security::EnterpriseData::FileProtectionInfo> UnprotectAsync(const Windows::Storage::IStorageItem & target, const Windows::Security::EnterpriseData::FileUnprotectOptions & options) const;
};
...
template <typename D>
struct WINRT_EBO impl_IFileUnprotectOptions
{
...
template <typename D>
struct WINRT_EBO impl_IFileUnprotectOptionsFactory
{
...
template <typename D>
struct WINRT_EBO impl_IProtectionPolicyManagerStatics4
{
    bool IsRoamableProtectionEnabled(hstring_view identity) const;
    Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> RequestAccessAsync(hstring_view sourceIdentity, hstring_view targetIdentity, const Windows::Security::EnterpriseData::ProtectionPolicyAuditInfo & auditInfo, hstring_view messageFromApp, Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior) const;
    ...
    Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> RequestAccessToFilesForAppAsync(iterable<Windows::Storage::IStorageItem> sourceItemList, hstring_view appPackageFamilyName, const Windows::Security::EnterpriseData::ProtectionPolicyAuditInfo & auditInfo, hstring_view messageFromApp, Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior) const;
    Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> RequestAccessToFilesForProcessAsync(iterable<Windows::Storage::IStorageItem> sourceItemList, uint32_t processId, const Windows::Security::EnterpriseData::ProtectionPolicyAuditInfo & auditInfo) const;
    Windows::Foundation::IAsyncOperation<winrt::Windows::Security::EnterpriseData::ProtectionPolicyEvaluationResult> RequestAccessToFilesForProcessAsync(iterable<Windows::Storage::IStorageItem> sourceItemList, uint32_t processId, const Windows::Security::EnterpriseData::ProtectionPolicyAuditInfo & auditInfo, hstring_view messageFromApp, Windows::Security::EnterpriseData::ProtectionPolicyRequestAccessBehavior behavior) const;
    Windows::Foundation::IAsyncOperation<bool> IsFileProtectionRequiredAsync(const Windows::Storage::IStorageItem & target, hstring_view identity) const;
    Windows::Foundation::IAsyncOperation<bool> IsFileProtectionRequiredForNewFileAsync(const Windows::Storage::IStorageFolder & parentFolder, hstring_view identity, hstring_view desiredName) const;
    hstring PrimaryManagedIdentity() const;
    hstring GetPrimaryManagedIdentityForIdentity(hstring_view identity) const;
};
...
template <> struct traits<Windows::Security::EnterpriseData::IFileProtectionManagerStatics3>
{
    using abi = ABI::Windows::Security::EnterpriseData::IFileProtectionManagerStatics3;
    template <typename D> using consume = Windows::Security::EnterpriseData::impl_IFileProtectionManagerStatics3<D>;
};
...
template <> struct traits<Windows::Security::EnterpriseData::IFileUnprotectOptions>
{
    using abi = ABI::Windows::Security::EnterpriseData::IFileUnprotectOptions;
    template <typename D> using consume = Windows::Security::EnterpriseData::impl_IFileUnprotectOptions<D>;
};

template <> struct traits<Windows::Security::EnterpriseData::IFileUnprotectOptionsFactory>
{
    using abi = ABI::Windows::Security::EnterpriseData::IFileUnprotectOptionsFactory;
    template <typename D> using consume = Windows::Security::EnterpriseData::impl_IFileUnprotectOptionsFactory<D>;
};
...
template <> struct traits<Windows::Security::EnterpriseData::IProtectionPolicyManagerStatics4>
{
    using abi = ABI::Windows::Security::EnterpriseData::IProtectionPolicyManagerStatics4;
    template <typename D> using consume = Windows::Security::EnterpriseData::impl_IProtectionPolicyManagerStatics4<D>;
};
...
template <> struct traits<Windows::Security::EnterpriseData::FileUnprotectOptions>
{
    using abi = ABI::Windows::Security::EnterpriseData::FileUnprotectOptions;
    static constexpr const wchar_t * name() noexcept { return L"Windows.Security.EnterpriseData.FileUnprotectOptions"; }
};
