...
#include "Windows.ApplicationModel.Appointments.DataProvider.2.h"

WINRT_EXPORT namespace winrt {

namespace Windows::ApplicationModel::Appointments::DataProvider {

struct WINRT_EBO AppointmentCalendarCancelMeetingRequest :
...
struct WINRT_EBO AppointmentCalendarCancelMeetingRequestEventArgs :
...
struct WINRT_EBO AppointmentCalendarCreateOrUpdateAppointmentRequest :
...
struct WINRT_EBO AppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs :
...
struct WINRT_EBO AppointmentCalendarForwardMeetingRequest :
...
struct WINRT_EBO AppointmentCalendarForwardMeetingRequestEventArgs :
...
struct WINRT_EBO AppointmentCalendarProposeNewTimeForMeetingRequest :
...
struct WINRT_EBO AppointmentCalendarProposeNewTimeForMeetingRequestEventArgs :
...
struct WINRT_EBO AppointmentCalendarSyncManagerSyncRequest :
...
struct WINRT_EBO AppointmentCalendarSyncManagerSyncRequestEventArgs :
...
struct WINRT_EBO AppointmentCalendarUpdateMeetingResponseRequest :
...
struct WINRT_EBO AppointmentCalendarUpdateMeetingResponseRequestEventArgs :
...
struct WINRT_EBO AppointmentDataProviderConnection :
...
struct WINRT_EBO AppointmentDataProviderTriggerDetails :
