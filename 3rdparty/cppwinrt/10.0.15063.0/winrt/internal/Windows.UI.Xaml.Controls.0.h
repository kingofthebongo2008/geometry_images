...
template <typename T> struct impl_IComboBox4;
...
template <typename T> struct impl_IComboBoxStatics4;
...
template <typename T> struct impl_IContentDialog2;
...
template <typename T> struct impl_IContentDialogStatics2;
...
template <typename T> struct impl_IControl5;
...
template <typename T> struct impl_IControlStatics5;
...
template <typename T> struct impl_IFocusEngagedEventArgs2;
...
template <typename T> struct impl_IFrame4;
...
template <typename T> struct impl_IInkToolbar2;
...
template <typename T> struct impl_IInkToolbarEraserButton2;
template <typename T> struct impl_IInkToolbarEraserButtonFactory;
template <typename T> struct impl_IInkToolbarEraserButtonStatics2;
template <typename T> struct impl_IInkToolbarFactory;
template <typename T> struct impl_IInkToolbarFlyoutItem;
template <typename T> struct impl_IInkToolbarFlyoutItemFactory;
template <typename T> struct impl_IInkToolbarFlyoutItemStatics;
...
template <typename T> struct impl_IInkToolbarIsStencilButtonCheckedChangedEventArgs;
template <typename T> struct impl_IInkToolbarMenuButton;
template <typename T> struct impl_IInkToolbarMenuButtonFactory;
template <typename T> struct impl_IInkToolbarMenuButtonStatics;
...
template <typename T> struct impl_IInkToolbarStatics2;
template <typename T> struct impl_IInkToolbarStencilButton;
template <typename T> struct impl_IInkToolbarStencilButtonFactory;
template <typename T> struct impl_IInkToolbarStencilButtonStatics;
...
template <typename T> struct impl_IListViewBase6;
...
template <typename T> struct impl_IMenuFlyoutItem2;
...
template <typename T> struct impl_IMenuFlyoutItemStatics2;
...
template <typename T> struct impl_IMenuFlyoutSubItem2;
template <typename T> struct impl_IMenuFlyoutSubItemStatics;
template <typename T> struct impl_IMenuFlyoutSubItemStatics2;
...
template <typename T> struct impl_IRichEditBox5;
...
template <typename T> struct impl_IRichEditBoxStatics5;
template <typename T> struct impl_IRichEditBoxTextChangingEventArgs;
template <typename T> struct impl_IRichEditBoxTextChangingEventArgs2;
...
template <typename T> struct impl_IRichTextBlock4;
...
template <typename T> struct impl_IRichTextBlockStatics4;
...
template <typename T> struct impl_ITextBlock5;
...
template <typename T> struct impl_ITextBlockStatics5;
...
template <typename T> struct impl_ITextBox5;
...
template <typename T> struct impl_ITextBoxStatics5;
template <typename T> struct impl_ITextBoxTextChangingEventArgs;
template <typename T> struct impl_ITextBoxTextChangingEventArgs2;
...
enum class CalendarViewDisplayMode
{
    Month = 0,
    Year = 1,
    Decade = 2,
...
enum class CalendarViewSelectionMode
{
    None = 0,
    Single = 1,
    Multiple = 2,
...
enum class CandidateWindowAlignment
{
    Default = 0,
    BottomEdge = 1,
};
...
enum class ComboBoxSelectionChangedTrigger
{
    Committed = 0,
    Always = 1,
};
...
enum class CommandBarOverflowButtonVisibility
{
    Auto = 0,
    Visible = 1,
    Collapsed = 2,
...
enum class IncrementalLoadingTrigger
{
    None = 0,
    Edge = 1,
};
...
enum class InkToolbarMenuKind
{
    Stencil = 0,
};

enum class InkToolbarStencilKind
{
    Ruler = 0,
    Protractor = 1,
};

enum class InkToolbarToggle
{
    Ruler = 0,
    Custom = 1,
};

enum class InkToolbarTool
{
    BallpointPen = 0,
    Pencil = 1,
    Highlighter = 2,
...
enum class ListPickerFlyoutSelectionMode
{
    Single = 0,
    Multiple = 1,
};
...
enum class PivotHeaderFocusVisualPlacement
{
    ItemHeaders = 0,
    SelectedItemHeader = 1,
};

enum class PivotSlideInAnimationGroup
{
    Default = 0,
    GroupOne = 1,
    GroupTwo = 2,
...
enum class RichEditClipboardFormat
{
    AllFormats = 0,
    PlainText = 1,
};
...
enum class SplitViewPanePlacement
{
    Left = 0,
    Right = 1,
};
...
enum class WebViewPermissionType
{
    Geolocation = 0,
