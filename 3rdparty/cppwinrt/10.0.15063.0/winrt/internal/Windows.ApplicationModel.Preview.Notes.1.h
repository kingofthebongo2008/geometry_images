...
struct __declspec(uuid("edfe864a-1f54-4b09-9823-ff477f6fa3bc")) __declspec(novtable) INotesWindowManagerPreview2 : Windows::Foundation::IInspectable
{
    virtual HRESULT __stdcall abi_ShowNoteRelativeToWithOptions(int32_t noteViewId, int32_t anchorNoteViewId, Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions * options) = 0;
    virtual HRESULT __stdcall abi_ShowNoteWithPlacementWithOptions(int32_t noteViewId, Windows::Storage::Streams::IBuffer * data, Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions * options) = 0;
    virtual HRESULT __stdcall abi_SetFocusToPreviousView() = 0;
    virtual HRESULT __stdcall abi_SetThumbnailImageForTaskSwitcherAsync(Windows::Graphics::Imaging::ISoftwareBitmap * bitmap, Windows::Foundation::IAsyncAction ** action) = 0;
};

struct __declspec(uuid("886b09d6-a6ae-4007-a56d-1ca70c84c0d2")) __declspec(novtable) INotesWindowManagerPreviewShowNoteOptions : Windows::Foundation::IInspectable
{
...
template <> struct traits<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions> { using default_interface = Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions; };
...
template <typename D>
struct WINRT_EBO impl_INotesWindowManagerPreview2
{
    void ShowNoteRelativeTo(int32_t noteViewId, int32_t anchorNoteViewId, const Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions & options) const;
    void ShowNoteWithPlacement(int32_t noteViewId, const Windows::Storage::Streams::IBuffer & data, const Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions & options) const;
    void SetFocusToPreviousView() const;
    Windows::Foundation::IAsyncAction SetThumbnailImageForTaskSwitcherAsync(const Windows::Graphics::Imaging::SoftwareBitmap & bitmap) const;
};

template <typename D>
struct WINRT_EBO impl_INotesWindowManagerPreviewShowNoteOptions
{
...
template <> struct traits<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview2>
{
    using abi = ABI::Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview2;
    template <typename D> using consume = Windows::ApplicationModel::Preview::Notes::impl_INotesWindowManagerPreview2<D>;
};

template <> struct traits<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions>
{
    using abi = ABI::Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions;
    template <typename D> using consume = Windows::ApplicationModel::Preview::Notes::impl_INotesWindowManagerPreviewShowNoteOptions<D>;
};
...
template <> struct traits<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions>
{
    using abi = ABI::Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreviewShowNoteOptions;
    static constexpr const wchar_t * name() noexcept { return L"Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreviewShowNoteOptions"; }
};
