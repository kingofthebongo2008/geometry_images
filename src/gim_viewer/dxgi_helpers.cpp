...
namespace dxgi
{
	...
	swap_chain_ptr	make_swap_chain( factory* f, IUnknown* d, const winrt::Windows::UI::Core::CoreWindow& w, uint32_t width, uint32_t height )
	{
		...
		desc.Flags			= DXGI_SWAP_CHAIN_FLAG_ALLOW_MODE_SWITCH | DXGI_SWAP_CHAIN_FLAG_ALLOW_TEARING | DXGI_SWAP_CHAIN_FLAG_FRAME_LATENCY_WAITABLE_OBJECT | DXGI_SWAP_CHAIN_FLAG_DISPLAY_ONLY;
